...
\node[state] (1) at (4,5) {1};
\node[state, accepting] (2) at (4,10) {2};
\node[state] (3) at (8,5) {3};
\node[state, accepting] (4) at (12,0) {4};
\node[state] (5) at (8,10) {5};
\node[state, accepting] (6) at (12,5) {6};
\draw[->, rounded corners=15pt] (6) -- (8,0) -- (4,0) -- (12) node[midway, sloped, above] {Tra};
